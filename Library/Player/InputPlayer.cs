...
namespace AutoClicker.Library.Player
{
    public class InputPlayer
    {
                    ...
                    while (enumerator.MoveNext())
                    {
                        try
                        {
                            ...
                            if (enumerator.Current.Value != null)
                            {
                                ...
                                {
                                    Console.WriteLine(
                                        $"Error returned with SendInput. ErrorCode: {err}"
                                    );
                                }
                                else // всё норм
                                {
        ...
        public virtual List<InputUnit> GetInputSequences(
